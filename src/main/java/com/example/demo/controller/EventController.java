...
public class EventController {
    ...
    public ResponseEntity<String> uploadRequest(@RequestHeader Integer loginUserId,@RequestParam String endDate,@RequestParam String startDate, @RequestParam String eventDetail, @RequestParam("eventPoster") MultipartFile uploadFile) {
